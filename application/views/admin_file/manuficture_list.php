        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                    ...
                    <tbody>
                    <?php $i=0;
                     foreach($manu_info as $val){ 
                            $i = $i+1; ?>
                        <tr>
                            <td><?php echo $i;?></td>
                            <td><?php echo $val->manufacture_name;?></td>
                            <td><?php echo $val->manufacture_description;?></td>
                            <td><?php 
                                 $pub = $val->manufacture_status;
                                 if( $pub=='1')
                                 {
                                    echo "Published";
                                 }else
                            ...
                            <td>
                           <a href="<?php echo base_url();?>Manufac_manage/edit_manu/<?php echo $val->manufacture_id;?>">Edit</a> || 

                            <a href="<?php echo base_url();?>Manufac_manage/delete_manu/<?php echo $val->manufacture_id;?>" onclick=" return checkDelete();">Delete</a>
                            </td>
                            <td>
                                <?php $pub = $val->manufacture_status;
                                if( $pub=='1') {?>
                                <a href="<?php echo base_url();?>Manufac_manage/publish_cat/<?php echo $val->manufacture_id;?>">UnPublish</a>

                                <?php }else{?>

                                <a href="<?php echo base_url();?>Manufac_manage/un_publish_cat/<?php echo $val->manufacture_id;?>">Publish</a>
                                <?php }?>
                            </td>
                        </tr>
