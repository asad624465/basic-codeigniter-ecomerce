<ul class="thumbnails listing-products">
		...
		<?php foreach ($hangbag_product as $value){?>
		<li class="span3">
			<div class="product-box">
				<span class="sale_tag"></span>												
				<a href="<?php echo base_url();?>Welcome/product_details/<?php echo $value->product_id;?>" max-height="50"><img alt="" src="<?php echo base_url().$value->product_img;?>">
				</a>
				<br/>
